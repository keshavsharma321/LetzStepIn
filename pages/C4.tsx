        ...
        <div className='-mt-4 -mb-12'>
                ...
                <div className="container  py-10 mx-auto">
                    <div className="lg:w-full mx-auto  flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-16 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <h1 className="text-gray-900 lg:mt-2 text-4xl title-font font-medium mb-1">Coworking And WorkStation In Pune</h1>
            ...
            <div className='flex w-11/12 ml-24 overflow-x-auto'>
                <div className="flex ">
                    ...
                    <img className='h-72 px-5' src="https://images.unsplash.com/photo-1614070776241-fb47ceC48278?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fGNvd29ya2luZ3xlbnwwfHwwfHx8MA%3D%3D"></img>
