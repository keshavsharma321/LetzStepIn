...
const H5 = () => {
    return (
        <div>
            <h1 className='flex justify-center text-5xl md:text-6xl p-4 md:p-0 mt-4 md:mt-4'>The Urban Heaven</h1>
            <div className='w-full lg:px-20 lg:py-24 flex  flex-col lg:flex-row'>
                <div className='w-full m-4 lg:w-1/2'><img className='h-96' src="/Categories/House/image5"></img></div>
