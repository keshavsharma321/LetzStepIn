    ...
    return (
        <div>
            ...
            <div className='w-full lg:px-20 lg:py-24 flex  flex-col lg:flex-row'>
                <div className='w-full m-4 lg:w-1/2'><img className='h-96' src="/Categories/education/image5"></img></div>
            ...
            <div className='px-16'>
                ...
                <div className='flex flex-col py-8  sm:flex-row  border-2 rounded-xl border-gray'>
                    <div className='px-10'>
                        ...
                        <div className='flex justify-center text-2xl mt-4'>GoodEducation</div>
                    </div>
                    <div className='px-16'>
                        <div><img src="https://cdn-icons-png.flaticon.com/128/1940/1940611.png"></img></div>
                        <div className='flex justify-center text-2xl mt-4'>GoodEducation</div>
                ...
                <h1 className='flex justify-center  text-5xl md:text-6xl my-20 '><i>Making your dreams comes true.</i></h1>
