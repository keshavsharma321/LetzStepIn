        ...
        <div>
            ...
            <div className="flex flex-wrap ">
                ...
                <div className='px-8 w-full justify-evenly'>
                    <div className='flex'>
                        <div className='w-2/3 h-80 px-2'><img style={{ height: 330, width: 1050 }} src="https://plus.unsplash.com/premium_photo-1661907977530-eb64ddbfb88a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8V2VkZGluZyUyMGhhbGxzJTIwaG9yaXpvbnRhbCUyMGltYWdlc3xlbnwwfHwwfHx8MA%3D%3D"></img></div>
                        <div className='w-1/3 h-80 px-2'><img className='ml-2' style={{ height: 320 }} src="https://plus.unsplash.com/premium_photo-1661306523308-d37fc69771b4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjl8fFdlZGRpbmclMjBoYWxsc3xlbnwwfHwwfHx8MA%3D%3D"></img></div>
                    </div>
                    <div className='flex mt-8'>
                        <div className='w-1/3 h-80 px-2'><img src="https://plus.unsplash.com/premium_photo-1678652647092-377ba6009daa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjV8fFdlZGRpbmclMjBoYWxsc3xlbnwwfHwwfHx8MA%3D%3D"></img></div>
                        <div className='w-1/3 h-80 px-2'><img src="https://images.unsplash.com/photo-1522413452208-996ff3f3e740?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fFdlZGRpbmclMjBoYWxsc3xlbnwwfHwwfHx8MA%3D%3D"></img></div>
                        <div className='w-1/3 h-80 px-2'><img src="https://plus.unsplash.com/premium_photo-1664530452358-d50d2d4a98d1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8TWFycmlhZ2UlMjBIYWxsc3xlbnwwfHwwfHx8MA%3D%3D"></img></div>
                    </div>
                </div>
                <div className='w-full justify-center self-center px-20'>
                    ...
                    <div className='border-2 border-grey-800 rounded-lg mt-10 w-full py-4'>
                        <div className='w-full py-6 flex'>
                            <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>For 300 Guests</b></h1></div>
                            <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 300k</h1></div>
                        ...
                        <div className='w-full py-6 flex'>
                            <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>For 700 Guests</b></h1></div>
                            <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 800k</h1></div>
                            <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                                <CustomAlert
                                    message="Added to cart!"
                                    onClose={handleCloseAlert}
                        ...
                        <hr className="flex-grow "></hr>
                        <div className='w-full py-6 flex'>
                            <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>For 1200 Guests</b></h1></div>
                            <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 1200k</h1></div>
                            <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                                <CustomAlert
                                    message="Added to cart!"
                                    onClose={handleCloseAlert}
