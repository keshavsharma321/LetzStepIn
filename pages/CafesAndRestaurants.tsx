...
const CafesAndRestaurants = () => {
  ...
  return (
    <div>
      ...
      <h1 className='flex justify-center py-10 font-serif text-6xl mb-4'>CoWorking And Community Space</h1>

      <div className="flex flex-wrap ">
        <div className='w-full justify-evenly flex h-1/4 p-10'>
          <div className='w-1/2'><iframe className='rounded-2xl ml-4' src="https://www.google.com/maps/embed?pb=!4v1708512434327!6m8!1m7!1sCAoSLEFGMVFpcE9EOUo0Qk1fcHdWbTdzdUdrOGFsNjdMYkVqVmQxZGtwMVNsaXhn!2m2!1d18.51053394956658!2d73.7817837945272!3f250.13315!4f0!5f0.7820865974627469" width="650" height="550" loading="lazy" ></iframe></div>
        ...
        <div className='flex px-8 w-full justify-center'>
          <div className='flex flex-col py-8 px-6  sm:flex-row  border-2 rounded-xl border-gray'>
            ...
            <div className='px-16'>
              ...
              <div className='flex justify-center text-2xl mt-8'>Private Call Room</div>
            </div>
            <div className='px-16'>
        ...
        <div className='px-12 w-full justify-evenly'>
          <div className='flex'>
            <div className=''><img style={{ height: 350, width: 800 }} src="https://plus.unsplash.com/premium_photo-1661931749081-23d69ddb62d1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y293b3JraW5nJTIwc3BhY2UlMjBob3Jpem9udGFsfGVufDB8fDB8fHww"></img></div>
            <div className=''><img style={{ height: 345, width: 530 }} className='ml-8' src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGNvd29ya2luZyUyMHNwYWNlfGVufDB8fDB8fHww"></img></div>
          </div>
          <div className='flex mt-8'>
            <div className='w-1/3 h-96 '><img src="https://images.unsplash.com/photo-1527192491265-7e15c55b1ed2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y293b3JraW5nJTIwc3BhY2V8ZW58MHx8MHx8fDA%3D"></img></div>
            <div className='w-1/3 h-96 px-8'><img src="https://images.unsplash.com/photo-1553028826-f4804a6dba3b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y293b3JraW5nJTIwc3BhY2V8ZW58MHx8MHx8fDA%3D"></img></div>
        ...
        <div className='w-full justify-center self-center px-20'>
          ...
          <div className='border-2 border-grey-800 rounded-lg mt-10 w-full py-4'>
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>1 Day Plan</b></h1></div>
            ...
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>1 Month Plan</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 2400</h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                <CustomAlert
                  message="Added to cart!"
                  onClose={handleCloseAlert}
            ...
            <hr className="flex-grow "></hr>
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>6 Months Plan</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 6500</h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                <CustomAlert
                  message="Added to cart!"
                  onClose={handleCloseAlert}
            ...
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>Annual Plan</b></h1></div>
