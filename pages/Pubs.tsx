...
const Pubs = () => {
  ...
  return (
    <div>
      ...
      <h1 className='flex justify-center py-10 font-serif text-6xl mb-4'>Reasturants And Services</h1>

      <div className="flex flex-wrap ">
        <div className='w-full justify-evenly flex h-1/4 p-10'>
          <div className='w-1/2'><iframe className='rounded-2xl ml-4' src="https://www.google.com/maps/embed?pb=!4v1708512692735!6m8!1m7!1sCAoSLEFGMVFpcE1yN1RFVVVtWnAzUVRqTWhwc2FZZFdhYzQtUTVSQzV5X09IZkZG!2m2!1d18.56308455246443!2d73.91774770852453!3f29.519587!4f0!5f0.7820865974627469" width="650" height="550" loading="lazy" ></iframe></div>
          <div className='w-1/2'><h1 className='text-8xl justify-center flex p-4 font-serif'><i>Rajmahal</i></h1>
        ...
        <div className='px-8 w-full justify-evenly'>
          <div className='flex'>
            <div className='w-2/3 h-80 px-2'><img style={{ height: 330, width: 1050 }} src="https://images.unsplash.com/photo-1570560258879-af7f8e1447ac?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjZ8fFJlc3RhdXJhbnRzfGVufDB8fDB8fHww"></img></div>
            <div className='w-1/3 h-80 px-2'><img className='ml-2' style={{ height: 320 }} src="https://plus.unsplash.com/premium_photo-1661883237884-263e8de8869b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8UmVzdGF1cmFudHN8ZW58MHx8MHx8fDA%3D"></img></div>
          </div>
          <div className='flex mt-8'>
            <div className='w-1/3 h-80 px-2'><img src="https://plus.unsplash.com/premium_photo-1670984940113-f3aa1cd1309a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8UmVzdGF1cmFudHN8ZW58MHx8MHx8fDA%3D"></img></div>
            <div className='w-1/3 h-80 px-2'><img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8UmVzdGF1cmFudHN8ZW58MHx8MHx8fDA%3D"></img></div>
            <div className='w-1/3 h-80 px-2'><img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8UmVzdGF1cmFudHN8ZW58MHx8MHx8fDA%3D"></img></div>
          </div>
        </div>
        <div className='w-full justify-center self-center px-20'>
          ...
          <div className='border-2 border-grey-800 rounded-lg mt-10 w-full py-4'>
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>North Indian</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 300</h1></div>
            ...
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>Italian</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 500</h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                <CustomAlert
                  message="Added to cart!"
                  onClose={handleCloseAlert}
            ...
            <hr className="flex-grow "></hr>
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>Chinese</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 650</h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                <CustomAlert
                  message="Added to cart!"
                  onClose={handleCloseAlert}
            ...
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>Family Combos</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 1200</h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                <CustomAlert
                  message="Added to cart!"
                  onClose={handleCloseAlert}
