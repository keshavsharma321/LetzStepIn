...
const RealEstate = () => {
  ...
  return (
    <div>
      ...
      <h1 className='flex justify-center py-10 font-serif text-6xl mb-4'>Spa And WellNess</h1>

      <div className="flex flex-wrap ">
        <div className='w-full justify-evenly flex h-1/4 p-10'>
          <div className='w-1/2'><iframe className='rounded-2xl ml-4' src="https://www.google.com/maps/embed?pb=!4v1708520057497!6m8!1m7!1sCAoSLEFGMVFpcE52aTFFV3JCSFZWU2FUbzE3VURYRnpuR28teWpydUlXZjRZTk5t!2m2!1d19.114588000254!2d72.826329080381!3f95.0441297575727!4f-10.052418875947481!5f0.4000000000000002" width="650" height="550" loading="lazy" ></iframe></div>
          <div className='w-1/2'><h1 className='text-8xl justify-center flex p-4 font-serif'><i>Aphrodite</i></h1>
            <p className='text-4xl px-10 py-9  text-center font-serif'>A spa is a location where mineral-rich spring water (and sometimes seawater) is used to give medicinal baths. Spa towns or spa resorts (including hot springs resorts) typically offer various health treatments, which are also known as balneotherapy.</p></div>
        </div>
        ...
        <div className='flex px-4 w-full justify-center'>
          <div className='flex justify-evenly w-full flex-col py-8 px-8  sm:flex-row  border-2 rounded-xl border-gray'>
            <div className='  '>
              ...
              <div className='flex justify-start text-2xl mt-8'>Best Staffs</div>
            </div>
            <div className=''>
            ...
            <div className=''>
              ...
              <div className='flex justify-center text-2xl mt-8'>Digital Bookings</div>
            </div>
            <div className=''>
        ...
        <div className='px-8 w-full justify-evenly'>
          <div className='flex'>
            <div className='w-2/3 h-80 px-2'><img style={{ height: 330, width: 1050 }} src="https://images.unsplash.com/photo-1554424518-336ec861b705?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTR8fFNwYXxlbnwwfHwwfHx8MA%3D%3D"></img></div>
            <div className='w-1/3 h-80 px-2'><img className='ml-2' style={{ height: 320 }} src="https://images.unsplash.com/photo-1583416750470-965b2707b355?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fFNwYXxlbnwwfHwwfHx8MA%3D%3D"></img></div>
          </div>
          <div className='flex mt-8'>
            <div className='w-1/3 h-80 px-2'><img src="https://images.unsplash.com/photo-1507652313519-d4e9174996dd?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fFNwYXxlbnwwfHwwfHx8MA%3D%3D"></img></div>
            <div className='w-1/3 h-80 px-2'><img src="https://images.unsplash.com/photo-1507652313519-d4e9174996dd?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fFNwYXxlbnwwfHwwfHx8MA%3D%3D"></img></div>
            <div className='w-1/3 h-80 px-2'><img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fFNwYXxlbnwwfHwwfHx8MA%3D%3D"></img></div>
          </div>
        </div>
        <div className='w-full justify-center self-center px-20'>
          <h1 className='text-6xl ml-12  mt-16 font-mono justify-start '>Memberships</h1>
          <div className='border-2 border-grey-800 rounded-lg mt-10 w-full py-4'>
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>Massages</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 1000</h1></div>
            ...
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>Hair Treatement</b></h1></div>
            ...
            <hr className="flex-grow "></hr>
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>BodyCare</b></h1></div>
            ...
            <div className='w-full py-6 flex'>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'><b>All Combos</b></h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><h1 className='text-4xl font-sans'>Starts From ₹ 5000</h1></div>
              <div className='w-1/3 flex justify-center text-center items-center'><button type="button" onClick={handleAddToCart} className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium  rounded-lg text-sm px-5 py-3 text-center me-2 flex "><img src="/images/add-to-basket-5854.png"></img><h1 className='ml-2 text-lg mt-1'>Add To Cart</h1></button></div> {showAlert && (
                <CustomAlert
                  message="Added to cart!"
                  onClose={handleCloseAlert}
