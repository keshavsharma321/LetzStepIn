...
const BR5 = () => {
    return (
        <div>
            <h1 className='flex justify-center text-5xl md:text-6xl p-4 md:p-0 mt-4 md:mt-4'>Desi Adda</h1>
            <div className='w-full lg:px-36 lg:py-24 flex  flex-col lg:flex-row'>
                <div className='w-full lg:w-1/2'><img className='h-96' src="/Categories/Bars/Image5"></img></div>
